...
-define(CHANNEL_VAR_HEADER_PREFIX, "X-ecallmgr_").
...
%%                     ,{<<?CHANNEL_LOOPBACK_HEADER_PREFIX, "Reseller-ID">>, wh_services:find_reseller_id(AccountId)}
%%                     ,{<<?CHANNEL_LOOPBACK_HEADER_PREFIX, "Channel-Authorized">>, <<"true">>}
                   ]),
